...
public class Swift3CodegenTest {
	...
	public void binaryDataTest() {
		...
		// TODO - have to be checked. It seems that there is a new expected value "Object"
		// set in the method:
		...
		// TODO - have to be checked - in the old code generator there was an expected
		// value set but in the current it isn't
		// I have no idea why...
		// Assert.assertTrue(getBooleanValue(op.responses.get(0),
		// CodegenConstants.IS_BINARY_EXT_NAME));
	}
