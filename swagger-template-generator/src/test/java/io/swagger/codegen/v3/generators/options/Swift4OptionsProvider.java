...
public class Swift4OptionsProvider implements OptionsProvider {
	...
	public Map<String, String> createOptions() {
		...
		return builder.put(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG, SORT_PARAMS_VALUE)
				...
				.put(Swift4Codegen.POD_SOURCE, POD_SOURCE_VALUE).put(CodegenConstants.POD_VERSION, POD_VERSION_VALUE)
				...
				.put(Swift4Codegen.POD_LICENSE, POD_LICENSE_VALUE).put(Swift4Codegen.POD_HOMEPAGE, POD_HOMEPAGE_VALUE)
