...
public class MicronautGeneratorCodegenTest extends AbstractCodegenTest {
	...
	public void generateCode() throws IOException {
		...
		final CodegenConfigurator configurator = new CodegenConfigurator().setLang("micronaut")
	...
	public void testConfigurations() {
		Assert.assertTrue(
				new File(output, "/src/main/java/io/swagger/configuration/UnsupportedOperationExceptionHandler.java")
						.exists());
	}
	...
	public void testApiParameters() throws IOException {
		final String expectedContent = "default Single<HttpResponse<LocalizedText>> updateTest(@Parameter(description = \"Localized Text object.\") @Valid @Body LocalizedText body"
				+ System.lineSeparator()
				+ ",@NotNull @Pattern(regexp=\"[0-9]+\") @Parameter(description = \"header description\") @Valid @Header(value = \"x-header\") String xHeader"
				+ System.lineSeparator()
