...
public class TitlecaseLambda implements Lambda {
	...
	/**
	 * Constructs a new instance of {@link io.swagger.codegen.mustache.TitlecaseLambda},
	 * which will convert all text in a space delimited string to title-case.
	 */
	...
	/**
	 * Constructs a new instance of {@link io.swagger.codegen.mustache.TitlecaseLambda},
	 * splitting on the specified delimiter and converting each word to title-case.
	 * <p>
