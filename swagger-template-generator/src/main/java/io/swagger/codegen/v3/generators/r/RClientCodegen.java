...
public class RClientCodegen extends DefaultCodegenConfig {
	...
	public RClientCodegen() {
		...
		languageSpecificPrimitives = new HashSet<String>(Arrays.asList("Integer", "Numeric", "Character"));
	...
	public String getTypeDeclaration(Schema schema) {
		if (schema instanceof ArraySchema) {
			...
			MapSchema mp = (MapSchema) schema;
			Object innerObject = mp.getAdditionalProperties();
			if (innerObject instanceof Schema) {
				return getTypeDeclaration((Schema) innerObject);
			}
		}
