...
public class GoClientCodegen extends AbstractGoCodegen {
	...
	public GoClientCodegen() {
		...
		this.setReservedWordsLowerCase(Arrays.asList("string", "bool", "uint", "uint8", "uint16", "uint32", "uint64",
				"int", "int8", "int16", "int32", "int64", "float32", "float64", "complex64", "complex128", "rune",
				"byte", "uintptr", "break", "default", "func", "interface", "select", "case", "defer", "go", "map",
		...
		this.cliOptions.add(CliOption.newBoolean("withXml",
