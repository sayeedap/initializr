...
public class AkkaHttpServerCodegen extends AbstractScalaCodegen {
	...
	/**
	 * Provide a lowercase representation of the http method to map to the method
	 * directives of akka http
	 * @see <a href=
	 * "https://doc.akka.io/docs/akka-http/current/routing-dsl/directives/method-directives/index.html">Akka
	 * Http Documentation</a>
	 */
	...
	/**
	 * Split the path as a string to a list of strings to map to the path directives of
	 * akka http
	 * @see <a href=
	 * "https://doc.akka.io/docs/akka-http/current/routing-dsl/directives/path-directives/index.html">Akka
	 * Http Documentation</a>
	 */
	 ...
	 * @see <a href=
	 * "https://doc.akka.io/docs/akka-http/current/routing-dsl/path-matchers.html#basic-pathmatchers">Akka
	 * Http Documentation</a>
	 */
	private static Map<String, String> pathTypeToMatcher = new HashMap<String, String>() {
		{
			...
			// put("List[???]","???"); TODO Could be implemented with a custom path
			// matcher
	...
	private static LinkedList<TextOrMatcher> replacePathsWithMatchers(LinkedList<String> paths,
			...
			if (path.startsWith("{") && path.endsWith("}")) {
				...
				for (CodegenParameter pathParam : codegenOperation.pathParams) {
					if (pathParam.paramName.equals(parameterName)) {
						...
						if (matcher == null) {
							LOGGER.warn("The path parameter " + pathParam.paramName + " with the datatype "
									+ pathParam.dataType
...
class TextOrMatcher {
	...
	public boolean equals(Object o) {
		...
		return isText == that.isText && hasMore == that.hasMore && value.equals(that.value);
	}
