...
// request.codegenVersion(GenerationRequest.CodegenVersion.V2).type(GenerationRequest.Type.CLIENT).lang("php")
// .spec(loadSpecAsNode("2_0/readme149.yaml", true, true)).options(new
// Options().outputDir(path)
// .gitRepoId("TestRepo").gitUserId("testuser").gitRepoBaseURL("gitlab"));
...
// .options(new Options().outputDir(path).gitRepoId("TestRepo").gitUserId("testuser"));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// for (File f : files) {
// String relPath = f.getAbsolutePath().substring(path.length());
...
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("php")
// .spec(loadSpecAsNode("3_0_0/readme149_v3.yaml", true, false)).options(new
// Options().outputDir(path)
// .gitRepoId("TestRepo").gitUserId("testuser").gitRepoBaseURL("https://gitlab.com"));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// for (File f : files) {
// String relPath = f.getAbsolutePath().substring(path.length());
...
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("html2")
...
// // api key
// Assert.assertTrue(
// FileUtils.readFileToString(f).contains("curl -X GET\\\n" + "-H \"api_key:
// [[apiKey]]\"\\"));
// // basic
// Assert.assertTrue(FileUtils.readFileToString(f)
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("html2")
// .spec(loadSpecAsNode("3_0_0/swos196.yaml", true, false)).options(new
// Options().outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("java")
// .spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
// .options(new
// Options().outputDir(path).addAdditionalProperty("notNullJacksonAnnotation", true));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// for (File f : files) {
...
// Assert.assertTrue(
// FileUtils.readFileToString(f).contains("import
...
// String relPath = f.getAbsolutePath().substring(path.length());
// if
// ("/src/main/java/io/swagger/client/model/ResponseCreateMeetingSettings.java".equals(relPath))
// {
// String fileContent = FileUtils.readFileToString(f);
// Assert.assertTrue(fileContent.contains("public static ApprovalTypeEnum
// fromValue(Integer input)"));
...
//
// @Test(description = "test generator service with java")
// public void testGeneratorService_notNullJacksonAnnotationJava_False() throws
// IOException {
//
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
...
// .spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
// .options(new
// Options().outputDir(path).addAdditionalProperty("notNullJacksonAnnotation", false));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// for (File f : files) {
...
// if ("/src/main/java/io/swagger/client/model/OrderLineAudit.java".equals(relPath)) {
// Assert.assertFalse(
// FileUtils.readFileToString(f).contains("@JsonInclude(JsonInclude.Include.NON_NULL)"));
// Assert.assertFalse(
// FileUtils.readFileToString(f).contains("import
// com.fasterxml.jackson.annotation.JsonInclude"));
// }
...
// public void testGeneratorService_notNullJacksonAnnotationSpring_True() throws
// IOException {
//
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("spring")
// .spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
// .options(new
// Options().outputDir(path).addAdditionalProperty("notNullJacksonAnnotation", true));
//
...
//
// @Test(description = "test generator service with spring")
// public void testGeneratorService_notNullJacksonAnnotationSpring_False() throws
// IOException {
//
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
...
// .options(new Options().flattenInlineComposedSchema(true).outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// for (File f : files) {
// String relPath = f.getAbsolutePath().substring(path.length());
// if
// ("/src/main/java/io/swagger/client/model/ContactbasemodelAllOf1.java".equals(relPath))
// {
...
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("html")
...
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT)
// .lang("jaxrs-cxf-client").spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
// .options(new Options().outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT)
// .lang("jaxrs-cxf-cdi").spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
// .options(new Options().outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT)
// .lang("jaxrs-resteasy-eap").spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
// .options(new Options().outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT)
// .lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
// .options(new Options().outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT)
// .lang("jaxrs-spec").spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
// .options(new Options().outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("spring")
// .spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false)).options(new
// Options().outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER).lang("spring")
// .spec(loadSpecAsNode("2_0/petstore.yaml", true, true)).options(new
// Options().outputDir(path));
//
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
//
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-jersey").spec(loadSpecAsNode("3_0_0/petstore.json", false, false))
// .options(new Options().outputDir(getTmpFolder().getAbsolutePath()));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// }
//
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-jersey").spec(loadSpecAsNode("3_0_0/noModel.yaml", true, false))
// .options(new Options().outputDir(path));
// List<File> files = new GeneratorService().generationRequest(request).generate();
...
//
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V2).type(GenerationRequest.Type.SERVER).lang("jaxrs")
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-jersey").spec(loadSpecAsNode("2_0/petstore.json", false, true))
// .options(new Options().outputDir(getTmpFolder().getAbsolutePath()));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// }
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-jersey").specURL("3_0_0/petstore.json")
// .options(new Options().outputDir(getTmpFolder().getAbsolutePath()));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// }
...
// .options(new Options().outputDir(getTmpFolder().getAbsolutePath())
// .artifactId("swagger-petstore-jersey2").library("jersey2")
// .addAdditionalProperty("useRuntimeException", true).addAdditionalProperty("useRxJava",
// true));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// }
...
// .options(new
// Options().outputDir(path).artifactId("swagger-petstore-jersey2").library("jersey2")
// .addAdditionalProperty("useRuntimeException", true).addAdditionalProperty("useRxJava",
// true));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// Assert.assertTrue(FileUtils.readFileToString(f).contains("Map<String, Object> foo =
// null"));
// }
// }
//
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V2).type(GenerationRequest.Type.CLIENT).lang("java")
// .spec(loadSpecAsNode("2_0/petstore.json", false, true))
// .options(new Options().outputDir(getTmpFolder().getAbsolutePath())
// .artifactId("swagger-petstore-jersey2").library("jersey2"));
// List<File> files = new GeneratorService().generationRequest(request).generate();
...
// String path = getTmpFolder().getAbsolutePath();
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.DOCUMENTATION)
// .lang("openapi").spec(loadSpecAsNode("3_0_0/flattentest.yaml", true, false))
// .options(new Options().outputDir(path).addAdditionalProperty("flattenSpec", false));
//
// new GeneratorService().generationRequest(request).generate();
// String spec = FileUtils.readFileToString(new File(path + File.separator +
// "openapi.json"));
...
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.DOCUMENTATION)
// .lang("openapi-yaml").spec(loadSpecAsNode("3_0_0/flattentest.yaml", true, false))
// .options(new Options().outputDir(path).addAdditionalProperty("flattenSpec", "false"));
//
// new GeneratorService().generationRequest(request).generate();
...
// request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.DOCUMENTATION)
// .lang("openapi-yaml").specURL("src/test/resources/3_0_0/resolvefullytest.yaml")
// .options(new Options().outputDir(path).resolveFully(true));
//
// new GeneratorService().generationRequest(request).generate();
// spec = FileUtils.readFileToString(new File(path + File.separator + "openapi.yaml"));
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT)
// .lang("typescript-angular").spec(loadSpecAsNode("3_0_0/petstore.json", false, false))
// .options(new Options().outputDir(getTmpFolder().getAbsolutePath()));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
// }
...
// *
// * to obtain a runnable server via jetty:run, in generated server code, replace the
// * following files with the ones in src/test/resources/3_0_0/issue-605/sertemplate
// *
// * pom.xml web.xml RestApplication.java InventoryApi.java
// *
// *
// */
// @Test
...
// .options(new
// Options().outputDir(path).library("resteasy").addAdditionalProperty("dateLibray",
// "time4j")
//
// );
// List<File> files = new GeneratorService().generationRequest(request).generate();
...
// request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-605/swagger.yaml", true,
// false))
// .options(new Options().outputDir(path)
//
// );
...
// GenerationRequest request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-612/cc-27814.yaml", true,
// false))
// .options(new Options().outputDir(path));
// List<File> files = new GeneratorService().generationRequest(request).generate();
// Assert.assertFalse(files.isEmpty());
...
// request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-613/cc-27916.yaml", true,
// false))
// .options(new Options().outputDir(path)
//
// );
...
// request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-605-612-613/swagger.yaml",
// true, false))
// .options(new Options().outputDir(path)
//
// );
...
// request = new GenerationRequest();
// request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
// .lang("jaxrs-jersey").spec(loadSpecAsNode("3_0_0/issue-605-612-613/swagger.yaml", true,
// false))
// .options(new Options().outputDir(path)
//
// );
...
// return new OpenAPIV3Parser().readLocation(path, null, options).getOpenAPI();
// }
//
// }
