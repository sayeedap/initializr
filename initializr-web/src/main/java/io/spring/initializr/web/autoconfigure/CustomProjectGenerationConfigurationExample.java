...
// System.out.println("CustomProjectGenerationController***");
// ProjectGenerationInvoker<CustomProjectRequest> projectGenerationInvoker = new
/// ProjectGenerationInvoker<>(
// applicationContext, new CustomProjectRequestToDescriptionConverter());
// return new CustomProjectGenerationController(metadataProvider,
/// projectGenerationInvoker);
// }
//
...
//
// @Override
// public ProjectDescription convert(CustomProjectRequest request, InitializrMetadata
/// metadata) {
