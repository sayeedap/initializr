...
public class MustacheTemplateEngine implements TemplateEngine {
	...
	public String getRendered(String templateFile, Map<String, Object> templateData) throws IOException {
		...
		}).defaultValue(StringUtils.EMPTY).compile(template);
	...
	public String getFullTemplateFile(CodegenConfig config, String templateFile) {
		...
		final String libTemplateFile = new StringBuilder(config.customTemplateDir()).append(File.separator)
				.append("libraries").append(File.separator).append(templateFile).toString();
