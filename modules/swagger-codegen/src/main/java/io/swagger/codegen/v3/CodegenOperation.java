...
public class CodegenOperation extends CodegenObject {
	...
	public String path, operationId, returnType, httpMethod, returnBaseType, returnContainer, summary, unescapedNotes,
			notes, baseName, defaultResponse, testPath;
	...
	public boolean getIsRestful() {
		return getIsRestfulIndex() || getIsRestfulShow() || getIsRestfulCreate() || getIsRestfulUpdate()
				|| getIsRestfulDestroy();
	}
