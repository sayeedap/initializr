 ...
 * <a href='https://github.com/atlassian/commonmark-java/issues/83'>This class is
 * threadsafe.</a>
 */
public class Markdown {
	 ...
	 * </p>
	 * .
	 * @param markdown text with Markdown styles. If <code>null</code>, <code>""</code> is
	 * returned.
	...
	private String unwrapped(String html) {
		if (html.startsWith(P_START) && html.endsWith(P_END) && html.lastIndexOf(P_START) == 0)
			return html.substring(P_START.length(), html.length() - P_END.length());
		else
			return html;
	}
