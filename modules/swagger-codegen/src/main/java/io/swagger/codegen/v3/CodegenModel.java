...
public class CodegenModel extends CodegenObject {
	...
	// References to parent and interface CodegenModels. Only set when code generator
	...
	public String name, classname, title, description, classVarName, modelJson, dataType, xmlPrefix, xmlNamespace,
			xmlName;
	...
	public List<CodegenProperty> requiredVars = new ArrayList<CodegenProperty>(); // a
																					// list
																					// of
																					// required
																					// properties

	public List<CodegenProperty> optionalVars = new ArrayList<CodegenProperty>(); // a
																					// list
																					// of
																					// optional
																					// properties

	public List<CodegenProperty> readOnlyVars = new ArrayList<CodegenProperty>(); // a
																					// list
																					// of
																					// read-only
																					// properties

	public List<CodegenProperty> readWriteVars = new ArrayList<CodegenProperty>(); // a
																					// list
																					// of
																					// properties
																					// for
...

	{
		...
		// inheritance, composed models
		// store the complete closure of owned and inherited properties in allVars and
		// allMandatory.
		allVars = vars;
