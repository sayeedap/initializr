...
public class GeneratorServiceTest {
	...
	public void testGeneratorService_readmeV2() throws IOException {
		...
		request.codegenVersion(GenerationRequest.CodegenVersion.V2).type(GenerationRequest.Type.CLIENT).lang("php")
				.spec(loadSpecAsNode("2_0/readme149.yaml", true, true)).options(new Options().outputDir(path)
	...
	public void testGeneratorService_readmeV3() throws IOException {
		...
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("php")
				.spec(loadSpecAsNode("3_0_0/readme149_v3.yaml", true, false)).options(new Options().outputDir(path)
	...
	public void testGeneratorService_HTML2() throws IOException {
		...
		GenerationRequest request = new GenerationRequest();
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("html2")
				.spec(loadSpecAsNode("3_0_0/swos196.yaml", true, false)).options(new Options().outputDir(path));
	...
	public void testGeneratorService_notNullJacksonAnnotationJava_True() throws IOException {
		...
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("java")
				...
				.options(new Options().outputDir(path).addAdditionalProperty("notNullJacksonAnnotation", true));
		...
		for (File f : files) {
			...
			if ("/src/main/java/io/swagger/client/model/OrderLineAudit.java".equals(relPath)) {
				...
				Assert.assertTrue(
						FileUtils.readFileToString(f).contains("import com.fasterxml.jackson.annotation.JsonInclude"));
			}
		}
	}
	...
	public void testGeneratorService_notNullJacksonAnnotationJava_False() throws IOException {
		...
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("java")
				.spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false))
				.options(new Options().outputDir(path).addAdditionalProperty("notNullJacksonAnnotation", false));
	...
	public void testGeneratorService_JavaSpring() throws IOException {
		...
		GenerationRequest request = new GenerationRequest();
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("spring")
				.spec(loadSpecAsNode("3_0_0/issue-9203.yaml", true, false)).options(new Options().outputDir(path));
	...
	public void testGeneratorService_JavaSpringPetStore() throws IOException {
		...
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER).lang("spring")
				.spec(loadSpecAsNode("2_0/petstore.yaml", true, true)).options(new Options().outputDir(path));
	...
	public void testGeneratorServiceJavaClient3() {
		...
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("java")
				...
				.options(new Options().outputDir(getTmpFolder().getAbsolutePath())
						...
						.addAdditionalProperty("useRuntimeException", true).addAdditionalProperty("useRxJava", true));
		List<File> files = new GeneratorService().generationRequest(request).generate();
		Assert.assertFalse(files.isEmpty());
	}
	...
	public void testGeneratorServiceBooleanAdditionalProperties() throws Exception {
		...
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("java")
				...
				.options(new Options().outputDir(path).artifactId("swagger-petstore-jersey2").library("jersey2")
						.addAdditionalProperty("useRuntimeException", true).addAdditionalProperty("useRxJava", true));
		List<File> files = new GeneratorService().generationRequest(request).generate();
		Assert.assertFalse(files.isEmpty());
		for (File f : files) {
	...
	public void testIssue605() throws IOException {
		...
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.CLIENT).lang("java")
				...
				.options(new Options().outputDir(path).library("resteasy").addAdditionalProperty("dateLibray", "time4j")
		...
		request = new GenerationRequest();
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
				.lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-605/swagger.yaml", true, false))
				.options(new Options().outputDir(path)
	...
	public void testIssue612_CC27814() throws IOException {
		...
		GenerationRequest request = new GenerationRequest();
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
				.lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-612/cc-27814.yaml", true, false))
				.options(new Options().outputDir(path));
		List<File> files = new GeneratorService().generationRequest(request).generate();
		Assert.assertFalse(files.isEmpty());
		System.out.println("Generated server in:\n" + path);
	...
	public void testIssue613_CC27916() throws IOException {
		...
		request = new GenerationRequest();
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
				.lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-613/cc-27916.yaml", true, false))
				.options(new Options().outputDir(path)
	...
	public void testIssue613_605_612() throws IOException {
		...
		request = new GenerationRequest();
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
				.lang("jaxrs-resteasy").spec(loadSpecAsNode("3_0_0/issue-605-612-613/swagger.yaml", true, false))
				.options(new Options().outputDir(path)
	...
	public void testIssue613_605_612_non_resteasy() throws IOException {
		...
		request = new GenerationRequest();
		request.codegenVersion(GenerationRequest.CodegenVersion.V3).type(GenerationRequest.Type.SERVER)
				.lang("jaxrs-jersey").spec(loadSpecAsNode("3_0_0/issue-605-612-613/swagger.yaml", true, false))
				.options(new Options().outputDir(path)
