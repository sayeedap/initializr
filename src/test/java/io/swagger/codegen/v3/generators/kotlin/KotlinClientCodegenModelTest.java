...
public class KotlinClientCodegenModelTest {
	...
	private Schema getArrayTestSchema() {
		final Schema propertySchema = new ArraySchema().items(new StringSchema()).description("an array property");
		return new Schema().type("object").description("a sample model").addProperties("examples", propertySchema);
	}

	private Schema getSimpleSchema() {
		return new Schema().type("object").description("a sample model")
				.addProperties("id", new IntegerSchema().format(SchemaTypeUtil.INTEGER64_FORMAT))
				.addProperties("first-name", new StringSchema().example("Tony"))
				.addProperties("createdAt", new DateTimeSchema()).addRequiredItem("id").addRequiredItem("first-name");
	}
	...
	private Schema getComplexSchema() {
		return new Schema().description("a sample model").type("object").addProperties("child",
	...
	public static Object[][] modelNames() {
		return new Object[][] { { "TestNs.TestClass", new ModelNameTest("TestNs.TestClass", "TestNsTestClass") },
				{ "$", new ModelNameTest("$", "Dollar") }, { "for", new ModelNameTest("`for`", "For") },
	...
	public static Object[][] enumNames() {
		return new Object[][] { { "VALUE1", "VALUE1" }, { "1", "_1" }, { "1X2", "_1X2" }, { "1x2", "_1X2" } };
	}
