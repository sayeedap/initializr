...
public class PythonClientCodegen extends DefaultCodegenConfig {
	...
	public PythonClientCodegen() {
		...
		setReservedWordsLowerCase(Arrays.asList(
				...
				"all_params", "resource_path", "path_params", "query_params", "header_params", "form_params",
				"local_var_files", "body_params", "auth_settings",
				// @property
				"property",
				...
				"finally", "is", "return", "def", "for", "lambda", "try", "self", "nonlocal", "None", "True",
				"nonlocal", "float", "int", "str", "date", "datetime", "False", "await", "async"));
		...
		cliOptions.add(
				new CliOption(CodegenConstants.PROJECT_NAME, "python project name in setup.py (e.g. petstore-api)."));
		cliOptions
	...
	public CodegenModel fromModel(String name, Schema schema, Map<String, Schema> allDefinitions) {
		...
		final List<String> imports = codegenModel.imports.stream().filter(model -> model.equals(codegenModel.parent))
	...
	public String toModelName(String name) {
		if (name == null) {
			// sanitizeName will return "Object" for null, but this is called "object" in
			// python
			return "object";
		}
		name = sanitizeName(name); // FIXME: a parameter should not be assigned. Also
	 ...
	 *
	 * (PEP 0008) Python packages should also have short, all-lowercase names, although
