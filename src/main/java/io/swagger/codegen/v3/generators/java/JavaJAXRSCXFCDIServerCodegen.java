...
/**
 * Generates a Java JAXRS Server according to JAXRS 2.0 specification, assuming an Apache
 * CXF runtime and a Java EE runtime with CDI enabled. Similar to the original JAXRS
 * generator, this creates API and Service classes in /src/gen/java and a sample
 * ServiceImpl in /src/main/java. The API uses CDI to get an instance of ServiceImpl that
...
public class JavaJAXRSCXFCDIServerCodegen extends JavaJAXRSSpecServerCodegen implements BeanValidationFeatures {
	...
	public void postProcessModelProperty(CodegenModel model, CodegenProperty property) {
		...
		if (useBeanValidation) {
			final boolean importValidAnnotation = property.getIsContainer() && !property.getIsPrimitiveType()
					&& !property.getIsEnum() || !property.getIsContainer() && !property.getIsPrimitiveType();
