...
public class TypeScriptAxiosClientCodegen extends AbstractTypeScriptClientCodegen {
	...
	/**
	 * Overriding toRegularExpression() to avoid escapeText() being called, as it would
	 * return a broken regular expression if any escaped character / metacharacter were
	 * present.
	 */
	@Override
