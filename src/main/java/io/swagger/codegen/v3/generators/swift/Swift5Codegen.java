...
public class Swift5Codegen extends DefaultCodegenConfig {
	...
	public void processOpts() {
		...
		/*
		 * Template Location. This is the location which templates will be read from. The
		 * generator will use the resource stream to attempt to read the templates.
		 */
		...
		supportingFiles.add(new SupportingFile("JSONValue.mustache", sourceFolder, "JSONValue.swift"));
	...
	protected boolean isReservedWord(String word) {
		return word != null && reservedWords.contains(word); // don't lowercase as super
																// does
	}
	...
	public String toEnumVarName(String name, String datatype) {
		...
		char[] separators = { '-', '_', ' ', ':', '(', ')' };
		return camelize(WordUtils.capitalizeFully(StringUtils.lowerCase(name), separators).replaceAll("[-_ :()]", ""),
				true);
	}
