...
public class TypeScriptAngularClientCodegen extends AbstractTypeScriptClientCodegen {
	...
	public void processOpts() {
		...
		supportingFiles.add(new SupportingFile("models.mustache", modelPackage().replace('.', '/'), "models.ts"));
		supportingFiles.add(new SupportingFile("apis.mustache", apiPackage().replace('.', '/'), "api.ts"));
		...
		// Angular Package format wasn't invented at this time and building was much more
		// easier
		...
		// Version after Angular 10 require ModuleWithProviders to be generic. Compatible
		// from version 7.
		...
		// Libraries generated with v1.x of ng-packagr will ship with AoT metadata in v3,
		// which is intended for Angular v4.
		// Libraries generated with v2.x of ng-packagr will ship with AoT metadata in v4,
		// which is intended for Angular v5 (and Angular v6).
