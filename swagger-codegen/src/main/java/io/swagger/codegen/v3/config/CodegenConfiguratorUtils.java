...
/**
 * Contains shared logic for applying key-value pairs and CSV strings to specific settings
 * in CodegenConfigurator.
 *
 * <p>
 * This class exists to facilitate testing. These methods could be applied to
 * CodegenConfigurator, but this complicates things when mocking CodegenConfigurator.
 * </p>
 * <ul>
 * <li>The methods named {@code apply...Kvp} take a string of comma-separated key-value
 * pairs.</li>
 ...
 * </ul>
 * <p>
 * The corresponding {@code add...} method on the passed configurator is called for each
