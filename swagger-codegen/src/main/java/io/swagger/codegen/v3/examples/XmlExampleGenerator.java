...
public class XmlExampleGenerator {
	...
	protected String modelImplToXml(Schema schema, int indent, Collection<String> path) {
		...
		if (properties != null && !properties.isEmpty()) {
			for (String pName : properties.keySet()) {
				...
				if (property != null && property.getXml() != null && property.getXml().getAttribute() != null
	 ...
	 *
	 * If an example value was not provided in the specification, a default will be
	 * generated.
	...
	protected String getExample(Schema property) {
		if (property.getExample() != null) {
			...
			// do these last in case the specific types above are derived from these
			// classes
		}
