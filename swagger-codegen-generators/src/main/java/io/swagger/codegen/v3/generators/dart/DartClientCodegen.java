...
public class DartClientCodegen extends DefaultCodegenConfig {
	...
	public DartClientCodegen() {
		...
		setReservedWordsLowerCase(Arrays.asList("abstract", "as", "assert", "async", "async*", "await", "break", "case",
				"catch", "class", "const", "continue", "default", "deferred", "do", "dynamic", "else", "enum", "export",
				"external", "extends", "factory", "false", "final", "finally", "for", "get", "if", "implements",
				"import", "in", "is", "library", "new", "null", "operator", "part", "rethrow", "return", "set",
				"static", "super", "switch", "sync*", "this", "throw", "true", "try", "typedef", "var", "void", "while",
				"int", "double", "with", "yield", "yield*"));

		languageSpecificPrimitives = new HashSet<String>(Arrays.asList("String", "bool", "int", "num", "double"));
	...
	private boolean buildEnumFromVendorExtension(CodegenModel codegenModel) {
		if (!getBooleanValue(codegenModel, IS_ENUM_EXT_NAME) || codegenModel.allowableValues == null
				|| !useEnumExtension || !codegenModel.vendorExtensions.containsKey("x-enum-values")) {
			return false;
		}
		...
		for (Map<String, Object> value : values) {
			...
			enumVar.put("value", toEnumValue(value.get("numericValue").toString(), codegenModel.dataType));
