...
public class JavaHelper {
	...
	public CharSequence getClassDefinition(CodegenModel codegenModel, Options options) throws IOException {
		final Boolean serializableModel = options.get(CodegenConstants.SERIALIZABLE_MODEL) != null
				? options.get(CodegenConstants.SERIALIZABLE_MODEL) : Boolean.FALSE;
		final Boolean parceableModel = options.get(JavaClientCodegen.PARCELABLE_MODEL) != null
				? options.get(JavaClientCodegen.PARCELABLE_MODEL) : Boolean.FALSE;
	...
	public CharSequence getJavaProperty(CodegenProperty codegenProperty, Options options) throws IOException {
		...
		return String.format("%s %s = %s", codegenProperty.getDatatypeWithEnum(), codegenProperty.getName(),
				codegenProperty.getDefaultValue());
	}
