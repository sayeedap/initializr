...
public abstract class AbstractScalaCodegen extends DefaultCodegenConfig {
	...
	public AbstractScalaCodegen() {
		...
		languageSpecificPrimitives.addAll(Arrays.asList("String", "boolean", "Boolean", "Double", "Int", "Long",
				"Float", "Object", "Any", "List", "Seq", "Map", "Array"));

		reservedWords.addAll(Arrays.asList("abstract", "case", "catch", "class", "def", "do", "else", "extends",
	...
	public String escapeReservedWord(String name) {
		...
		// Scala escaping done here (via `, without compiler escaping) would otherwise be
		// HTML encoded.
		return "`" + name + "`";
	}
	...
	public Mustache.Compiler processCompiler(Mustache.Compiler compiler) {
		Mustache.Escaper SCALA = new Mustache.Escaper() {
			...
			public String escape(String text) {
				...
				// All none reserved words will be escaped with the default Mustache
				// `HTML` escaper
